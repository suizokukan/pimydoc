...
from pimydoc.pimydoc import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    url='https://github.com/suizokukan/pimydoc',
    ...
    entry_points={
        'console_scripts': ['pimydoc=pimydoc.pimydoc:main',],
    },
)
